...
function wrapInDelimiters(lines, indent = "", delimiters = "{}") {
  if (!lines.length) {
    return delimiters;
  }
...
export { escapeString, genArrayFromRaw, genDynamicImport, genExport, genImport, genObjectFromRaw, genObjectFromRawEntries, genString };
