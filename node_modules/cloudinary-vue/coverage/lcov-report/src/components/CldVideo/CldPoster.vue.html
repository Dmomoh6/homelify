...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/components/CldVideo</a> CldPoster.vue
    </h1>
    <div class='clearfix'>
    </div>
  </div>
...
export default {
  ...
  mounted() {
<span class="missing-if-branch" title="else path not taken" >E</span>    if (this.registerPoster) {
<span class="branch-1 cbranch-no" title="branch not covered" >      const posterAttrs = this.$attrs || {};</span>
